...
import app.coronawarn.verfication.services.domain.CoronaVerificationTAN;
import app.coronawarn.verfication.services.repository.CoronaVerficationTANRepository;
...
public class TanService {
  ...
  /**
   * This Method tries to create a valid Tan from the parameter and persists it if it is valid
   *
