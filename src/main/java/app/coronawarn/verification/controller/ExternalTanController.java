...
public class ExternalTanController {
  ...
  public ResponseEntity<Tan> generateTanWithFakeHeader(@Valid @RequestBody RegistrationToken registrationToken) {
    return generateTan(registrationToken);
  }
