...
public class TestResultServerServiceTest {
  ...
  public static final TestResult TEST_LAB_POSITIVE_RESULT = new TestResult(2,TEST_RESULT_PADDING);
  public static final TestResult TEST_LAB_REDEEMED_RESULT = new TestResult(4,TEST_RESULT_PADDING);
  ...
  public static class TestResultServerClientMock implements TestResultServerClient {
    ...
    public TestResult result(HashedGuid guid) {
      if (guid.getId().equals(TEST_GUI_HASH_1)) {
        return new TestResult(2,TEST_RESULT_PADDING);
      }
      return new TestResult(4,TEST_RESULT_PADDING);
    }
  }
}
